...
var QuestionsController = /*#__PURE__*/function () {
  ...
  _createClass(QuestionsController, null, [{
    ...
    key: "getAQuestion",
    value: function () {
      var _getAQuestion = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var id, question;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                try {
                  ...
                  id = req.params.id; // check if the question exists in the database
      ...
      function getAQuestion(_x3, _x4) {
        return _getAQuestion.apply(this, arguments);
      }
    ...
    key: "addAQuestion",
    value: function () {
      var _addAQuestion = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        var _req$body, title, description, question;
      ...
      function addAQuestion(_x5, _x6) {
        return _addAQuestion.apply(this, arguments);
      }
